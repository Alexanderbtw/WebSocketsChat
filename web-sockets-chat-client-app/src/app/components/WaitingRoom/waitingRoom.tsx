...
export const WaitingRoom: FunctionComponent<Props> = ({
    joinChatRoom,
}) => {
    ...
    return (
        <form className="self-center w-1/2 border p-6 rounded-xl" onSubmit={ e => {
            e.preventDefault();
            ...
            <div className="border-b border-white-900/10">
                ...
                <div className="my-6">
                    <label htmlFor="chat" className="block text-sm font-medium leading-6 text-gray-400">
                        Chat
                    </label>
                    <div className="mt-2 flex rounded-md ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                        <input
